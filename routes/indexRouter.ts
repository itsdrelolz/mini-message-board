...
import * as indexController from '../controllers/indexController'; // Use ES module syntax
...
indexRouter.get("/messages/:id", indexController.viewUserMessageGet);


module.exports = indexRouter // Use ES module export
